      ...
      <div className="relative h-48 group/preview">
        ...
        {onExpand && (
          <button
            type="button"
            onClick={onExpand}
            className="absolute top-2 right-2 p-1.5 bg-white/90 border border-gray-200 rounded-md text-gray-500 hover:text-purple-600 hover:bg-white opacity-0 group-hover/preview:opacity-100 transition-opacity shadow-sm"
            title="Ver en grande"
          >
