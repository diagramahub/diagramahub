...
const AnimatedBackground: React.FC = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-gradient-to-br from-purple-50 via-white to-pink-50">
      {/* Blob 1 — grande, arriba-izquierda */}
      <div
        className="absolute -top-32 -left-32 w-[700px] h-[700px] rounded-full opacity-40 blur-3xl"
        style={{
      ...
      <div
        className="absolute top-1/4 -right-20 w-[600px] h-[600px] rounded-full opacity-35 blur-3xl"
        style={{
      ...
      {/* Blob 3 — centro-abajo */}
      <div
        className="absolute bottom-10 left-1/3 w-[500px] h-[500px] rounded-full opacity-30 blur-3xl"
        style={{
      ...
      <div
        className="absolute -top-10 right-1/4 w-[450px] h-[450px] rounded-full opacity-30 blur-3xl"
        style={{
      ...
      <div
        className="absolute -bottom-20 -left-10 w-[550px] h-[550px] rounded-full opacity-25 blur-3xl"
        style={{
