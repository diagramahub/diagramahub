...
class TestResendAdapter:
    ...
    def test_implements_interface(self):
        ...
        adapter = ResendAdapter(api_key="re_test_123", from_email="noreply@example.com")
    ...
    def test_constructor_stores_config(self):
        ...
        adapter = ResendAdapter(api_key="re_key_abc", from_email="sender@test.com")
        assert adapter.api_key == "re_key_abc"
    ...
    async def test_send_email_with_custom_from(self, mock_resend):
        ...
        adapter = ResendAdapter(api_key="re_test_123", from_email="default@example.com")
    ...
    async def test_test_connection_success(self, mock_resend):
        ...
        adapter = ResendAdapter(api_key="re_valid_key", from_email="noreply@example.com")
    ...
    async def test_test_connection_failure(self, mock_resend):
        ...
        adapter = ResendAdapter(api_key="re_bad_key", from_email="noreply@example.com")
