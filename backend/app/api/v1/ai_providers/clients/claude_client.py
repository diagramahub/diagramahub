...
class ClaudeClient(BaseAIClient):
    ...
    def __init__(self, api_key: str, model: str = "claude-3-5-sonnet-20241022", parameters: Dict[str, Any] = None):
        """
    ...
    async def generate_description(
        ...
        """
        Generate diagram description using Claude.
...
GENERATE THE DIAGRAM CODE:"""
        ...
        try:
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                diagram_code = result["content"][0]["text"].strip()
...
GENERATE THE IMPROVED DIAGRAM CODE:"""
        ...
        try:
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                improved_code = result["content"][0]["text"].strip()
...
7. Prefer simple and readable diagrams"""
    ...
    async def chat_with_context(
        ...
        """
        Conversación con contexto de historial y diagrama usando Claude.
        """
        if language == "es":
...
Respond clearly and helpfully in English. Do not modify the diagram unless explicitly asked."""
        ...
        # Claude uses a top-level "system" field, not a system message in the array
        api_messages = []
        for msg in messages:
    ...
    async def summarize_conversation(
        ...
        """
        Genera un resumen compacto de una conversación usando Claude.
        """
        conversation_text = "\n".join(
