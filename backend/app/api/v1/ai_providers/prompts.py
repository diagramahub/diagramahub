...
def build_unified_chat_prompt(
    ...
    if language == "es":
        ...
        return (
            ...
            "<<<END_DIAGRAM>>>\n\n"
            "Breve explicacion (maximo 2-3 lineas) de los cambios realizados.\n\n"
            "REGLAS CRITICAS:\n"
            "- PRIMERO el codigo entre delimitadores, DESPUES la explicacion breve\n"
            ...
            "- La explicacion debe ser MUY breve (2-3 lineas maximo). NO repetir el codigo ni describir cada elemento\n"
        ...
        return (
            ...
            "<<<END_DIAGRAM>>>\n\n"
            "Brief explanation (max 2-3 lines) of the changes made.\n\n"
            "CRITICAL RULES:\n"
            "- FIRST the code between delimiters, THEN the brief explanation\n"
            ...
            "- The explanation must be VERY brief (2-3 lines max). Do NOT repeat the code or describe each element\n"
